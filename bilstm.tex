	...
	\begin{center}
		\only<1>{
			\begin{figure}
				...
				\caption{Forward propagation - getting output}
			\end{figure}
		}
		\only<2>{
			\begin{figure}
				\includegraphics[width=0.8\textwidth]{imgs/backpropagation.png}
				\caption{Back propagation - calculating A LOT of derivatives}
			\end{figure}
		}
	\end{center}
\end{frame}
	...
	\only<1>{
		...
		\begin{center}
			\begin{tabular}{ c  m{5cm} }
				...
				\begin{figure}
						\includegraphics[width=0.8\textwidth,trim={3cm 0 20cm 0},clip]{imgs/lstmandgru.png}
						 \caption{LSTM cell}
					\end{figure}
				\end{minipage}
